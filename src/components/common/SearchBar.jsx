    ...
    <div className="relative flex-1">
      ...
      {localValue && (
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center justify-center h-5 w-5 rounded-full bg-slate-300/70 hover:bg-slate-400/70 text-slate-600 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
        >
          <X className="h-3 w-3" />
        </button>
      )}
