        ...
        <table className="w-full table-fixed border-collapse text-left text-sm">
          <thead>
            <tr className="bg-slate-50/75 dark:bg-gray-800/80 border-b border-slate-200 dark:border-gray-700 text-xs font-bold text-slate-500 dark:text-gray-400 uppercase tracking-wider">
              <th scope="col" className="w-[20%] px-3 py-2">Lead Detail</th>
              <th scope="col" className="hidden w-[16%] px-3 py-2 lg:table-cell">Company</th>
              <th scope="col" className="w-[18%] px-3 py-2 lg:w-[14%]">Status</th>
              <th scope="col" className="w-[38%] px-3 py-2 lg:w-[22%]">Email</th>
              <th scope="col" className="hidden w-[10%] px-3 py-2 xl:table-cell">Source</th>
              <th scope="col" className="hidden w-[10%] px-3 py-2 xl:table-cell">Date Added</th>
              <th scope="col" className="w-[24%] px-3 py-2 text-right lg:w-[12%] xl:w-[8%]">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-100 dark:divide-gray-700">
            {leads.length > 0 ? (
              leads.map((lead) => {
                ...
                return (
                  <tr key={lead.id} className="hover:bg-slate-50/50 dark:hover:bg-gray-800/50 transition-colors group">
                    ...
                    <td className="hidden px-3 py-2 align-middle text-xs font-semibold text-slate-500 xl:table-cell dark:text-gray-400">
                    ...
                    <td className="hidden px-3 py-2 align-middle text-xs font-semibold text-slate-400 xl:table-cell dark:text-gray-500">
              ...
              <tr>
                <td colSpan={7} className="px-3 py-10 text-center text-sm font-semibold text-slate-400 dark:text-gray-500">
